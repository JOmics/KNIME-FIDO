 ...
 * @author enrique
 */
public class FidoProteinInferenceNodePlugin extends Plugin {
    // The shared instance.
    private static FidoProteinInferenceNodePlugin plugin;

    /**
     * The constructor.
     */
    public FidoProteinInferenceNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FidoProteinInferenceNodePlugin getDefault() {
        return plugin;
    }
